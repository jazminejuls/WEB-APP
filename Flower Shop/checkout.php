...
<section class="checkout">
    ...
    <form action="" method="POST">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                <span>House no. :</span>
                <input type="text" name="flat" placeholder="e.g. 123">
            </div>
            <div class="inputBox">
            ...
            <div class="inputBox">
                ...
                <input type="text" name="city" placeholder="e.g. Makati City">
            </div>
            <div class="inputBox">
                <span>Barangay :</span>
                <input type="text" name="state" placeholder="e.g. Mabuhay">
            </div>
            <div class="inputBox">
                <span>Country :</span>
            ...
            <div class="inputBox">
                <span>Zip code :</span>
                <input type="number" min="0" name="pin_code" placeholder="e.g. 1400">
            </div>
        </div>
